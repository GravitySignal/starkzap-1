...
function isWebRuntimeForCartridge() {
...
export class StarkSDK {
    ...
    resolveConfig(config) {
        ...
        if (!rpcUrl) {
            throw new Error("StarkSDK requires either 'network' or 'rpcUrl' to be specified");
        }
        ...
        if (!chainId) {
            throw new Error("StarkSDK requires either 'network' or 'chainId' to be specified");
        }
